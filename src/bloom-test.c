...
int main(int argc, char* argv[]) {
  ...
  if ( optimal_size(3000,c) != 12 ) { error_count++; if (argc > 2) printf("\nError: size 3000"); }
  if ( optimal_size(4000,c) != 12 ) { error_count++; if (argc > 2) printf("\nError: size 4000"); }
  if ( optimal_size(5000,c) != 13 ) { error_count++; if (argc > 2) printf("\nError: size 5000"); }
  if ( optimal_size(8000,c) != 13 ) { error_count++; if (argc > 2) printf("\nError: size 8000"); }
  if ( optimal_size(9000,c) != 14 ) { error_count++; if (argc > 2) printf("\nError: size 9000"); }
  if ( optimal_size(16000,c) != 14 ) { error_count++; if (argc > 2) printf("\nError: size 16000"); }
  if ( optimal_size(17000,c) != 15 ) { error_count++; if (argc > 2) printf("\nError: size 17000"); }
  if ( optimal_size(32000,c) != 15 ) { error_count++; if (argc > 2) printf("\nError: size 32000"); }
  if ( optimal_size(33000,c) != 16 ) { error_count++; if (argc > 2) printf("\nError: size 33000"); }
  if ( optimal_size(65000,c) != 16 ) { error_count++; if (argc > 2) printf("\nError: size 65000"); }
  if ( optimal_size(66000,c) != 17 ) { error_count++; if (argc > 2) printf("\nError: size 66000"); }
  if ( optimal_size(131000,c) != 17 ) { error_count++; if (argc > 2) printf("\nError: size 131000"); }
  if ( optimal_size(132000,c) != 18 ) { error_count++; if (argc > 2) printf("\nError: size 132000"); }
  if ( optimal_size(262000,c) != 18 ) { error_count++; if (argc > 2) printf("\nError: size 262000"); }
  if ( optimal_size(263000,c) != 19 ) { error_count++; if (argc > 2) printf("\nError: size 263000"); }
  if ( optimal_size(524000,c) != 19 ) { error_count++; if (argc > 2) printf("\nError: size 524000"); }
  if ( optimal_size(525000,c) != 20 ) { error_count++; if (argc > 2) printf("\nError: size 525000"); }
  if ( optimal_size(1048000,c) != 20 ) { error_count++; if (argc > 2) printf("\nError: size 1048000"); }
  if ( optimal_size(1049000,c) != 21 ) { error_count++; if (argc > 2) printf("\nError: size 1049000"); }
  ...
  for ( i=0 ; i<j ; i++ ) {
    sprintf(test, "%d", i);
    if ( !is_in_array(bfg->filter_group[0], sha256_string(test)) ) { error_count++; if (argc > 2) printf("\nError: %s not in array bfg[0]", test); }
  }

  if ( argc > 1 && strcmp(argv[1], "visualize") == 0 ) { printf("\nbfg[0]: "); debug_print_filter(bfg->filter_group[0],FALSE); }
